...
protected:
    ...
    zakhar_msgs::EmotionParams current_msg;
...
public:
    ...
    static bool handler_EmotionCoreWrite_handler(zakhar_msgs::EmotionCoreWrite::Request &req,
                                                 zakhar_msgs::EmotionCoreWrite::Response &res);

    static bool handler_EmotionCoreDataDescriptor(zakhar_msgs::EmotionCoreDataDescriptor::Request &req,
